...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['assign_course'])) {
    foreach ($_POST['assign_course'] as $student_id => $course) {
        ...
        $updateStmt = $conn->prepare("UPDATE tbl_student SET course_assigned = :course, ass = true WHERE student_id = :student_id");
...
<body>
    ...
    <div class="main">
        <div class="content">
            ...
            <hr>
            <!-- Sorting form -->
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="GET" class="mb-3" style="position:fixed; right:10px;">
